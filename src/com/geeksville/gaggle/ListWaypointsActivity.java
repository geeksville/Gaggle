...
public class ListWaypointsActivity extends DBListActivity implements Observer {
    ...
    if (uri != null && action != null && action.equals(Intent.ACTION_VIEW)) {
      ...
      AsyncProgressDialog progress = new AsyncProgressDialog(this,
        ...
        protected void doInBackground() {
          ...
          try {
            InputStream s = AndroidUtil.getFromURI(ListWaypointsActivity.this,
                uri);
            ...
            String msg = String.format(
                getString(R.string.imported_d_waypoints), numadded);
         ...
         * (non-Javadoc)
         * 
         * @see com.geeksville.view.AsyncProgressDialog#onPostExecute(java
         * .lang.Void)
         */
        @Override
  ...
  protected BaseAdapter createListAdapter() {
    ...
    String[] from = new String[] { LocationLogDbAdapter.KEY_NAME,
        LocationLogDbAdapter.KEY_DESCRIPTION, WaypointCursor.KEY_DIST_PILOTX,
        LocationLogDbAdapter.KEY_WAYPOINT_TYPE, WaypointCursor.KEY_DIST_PILOTY };
  ...
  private void handleAddWaypoint() {
    ...
    if (myloc == null)
      ...
      ExtendedWaypoint w = new ExtendedWaypoint(name, myloc.getLatitude(),
          myloc.getLongitude(), (int) myloc.getAltitude(), 0,
      ...
      Toast.makeText(ListWaypointsActivity.this, R.string.waypoint_created,
  ...
  private void gotoWaypoint(int rownum) {
    ...
    Toast.makeText(ListWaypointsActivity.this,
        getString(R.string.new_destination) + w.name, Toast.LENGTH_SHORT)
        .show();
  }
  ...
  private void handleViewItem(final int rownum) {
    ...
    Runnable onOkay = new Runnable() {
      ...
      public void run() {
        ...
        Toast.makeText(ListWaypointsActivity.this, R.string.updated_waypoint,
            Toast.LENGTH_SHORT).show();
      }
    };
